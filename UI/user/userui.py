...
import mpok.user as testimport
...
def show_dashboard(app):
    ...
    ctk.CTkButton(master=sidebar_frame, image=analytics_img, text="Dashboard", command=lambda: testimport.setup_app(app), fg_color="transparent", font=("Arial Bold", 14), hover_color="#207244", anchor="w").pack(anchor="center", ipady=5, pady=(60, 0))
