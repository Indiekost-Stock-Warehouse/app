...
def edit_row():
    ...
    if selected_item:
        ...
        print(f"Edit: {item_data}")  # Here you can add functionality to edit this item
...
def delete_row():
    ...
    if selected_item:
        item_data = table.item(selected_item, "values")
        print(f"Delete: {item_data}")  # Confirm deletion in a real scenario
...
edit_button = CTkButton(bottom_frame, text="Edit", command=edit_row, state="disabled")
edit_button.pack(side="right", padx=10)

delete_button = CTkButton(bottom_frame, text="Delete", command=delete_row, state="disabled")
delete_button.pack(side="right", padx=10)

# Function to enable Edit and Delete buttons when a row is selected
...
# Bind the row selection event to enable Edit/Delete buttons
